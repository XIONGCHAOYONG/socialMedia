  ...
  <div class="home">
    <div class="info">
      <el-descriptions direction="vertical" border :column="3">
        ...
        <el-descriptions-item label="注册时间">{{ userInfo?.createdAt || '未设置' }}</el-descriptions-item>
...
const fetchUserInfo = async () => {
  // 获取用户信息
  userInfo.value = loginStore.getUser;
};
...
const handleSaveEdit = async () => {
  ...
  if (res.data.code == 1) {
    await loginStore.fetchUser(loginStore.getUser.id)
